...
namespace MKMCrawler.Logica
{
    class OAuthHeader
    {
        /// <summary>App Token</summary>
        protected String appToken = "EWDGc7y5AUvgwiWU";
        /// <summary>App Secret</summary>
        protected String appSecret = "M1gfWE2Z2cFOASJsRqE4hDLZgAaCsOuk";
        /// <summary>Access Token (Class should also implement an AccessToken property to set the value)</summary>
        protected String accessToken = "j7a3ryQUORAGl3PJZJ0sFs8LcBfRMTaP";
        /// <summary>Access Token Secret (Class should also implement an AccessToken property to set the value)</summary>
        protected String accessSecret = "U11UI4s7hpSLgsU5F1u6yj0xotHN6H5s";
